...
class LevelEight(AbstractLevel):
    ...
    def __init__(self, display):
        ...
        self.background = pygame.transform.scale(self.load_img('13_background.png', add_sub_dir=['background_pack']), (self.display.get_width(), self.display.get_height())) 
        ...
        self.ground = pygame.transform.scale(self.load_img('02_ground.png', add_sub_dir=['background_pack']), (self.display.get_width(), self.display.get_height())) 
